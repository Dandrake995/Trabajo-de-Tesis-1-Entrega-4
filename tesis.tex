...
\fancypagestyle{special}{%
	\fancyhead[L]{\changefont Sistema predictivo de visión por computadora e IA para detección de comportamientos
...
\begin{titlepage}
	...
	\begin{center}
		...
		\vspace*{8ex} \\
		%\textbf
		{Sistema predictivo de visión por computadora e IA para detección de comportamientos
sospechosos en entornos urbanos}
		\vspace*{8ex}\\	
